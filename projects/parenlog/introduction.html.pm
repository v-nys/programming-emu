...
The mother of all logic programming languages is ◊a[#:href "https://en.wikipedia.org/wiki/Prolog"]{Prolog}. What's unusual about Prolog is that you, as a programmer, encode knowledge much more directly than you would in most languages. And knowledge, unlike your typical imperative instructions, is flexible. It works in several directions. Let's say you are given the following bits of information:
