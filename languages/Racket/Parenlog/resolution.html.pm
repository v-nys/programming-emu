...
◊code-discussion[◊listing[#:source "code/resolution.rkt" #:lang "scheme" #:fn "core.rkt" #:highlights '((1 9) (1 16))]{◊code{reyield} is just a convenience function. Sometimes, we just want to delegate to a "smaller" generator. We can't ◊code{yield} that generator, because then the caller would get a generator, rather than the values produced by that generator.}
