...
◊listing[#:source "code/rename-variables-test.rkt" #:lang "scheme"]
And here's how I did it:
◊listing[#:source "code/rename-variables.rkt" #:lang "scheme"]
...
◊listing[#:source "code/generator-example.rkt" #:lang "scheme"]
...
◊listing[#:source "code/resolution.rkt" #:lang "scheme"]
...
◊listing[#:source "code/dereferenced-resolution-example.rkt" #:lang "scheme"]

Here's my version:
◊listing[#:source "code/restrict.rkt" #:lang "scheme"]